                ...
                <ul>
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-red-500'>
                        <a className='flex justify-between items-center w-full text-grey-300'
                            href='https://drive.google.com/file/d/11WTDcm0dCA33IpXTYZqhc7xT0olic4e9/view?usp=share_link'>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-500'>
                        <a className='flex justify-between items-center w-full text-grey-300'
                            href='https://www.linkedin.com/in/akash-sharma-8152711a7/'>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-black'>
                        <a className='flex justify-between items-center w-full text-grey-300'
                            href='https://github.com/akash-55'>
